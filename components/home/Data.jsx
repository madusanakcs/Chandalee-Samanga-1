...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">CHANDALEE KALUBANDARA
        {/* Keeping the hand icon for a friendly greeting */}
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Detail-oriented Data Analyst 📊</h3>
<p className="about__description">
  Detail-oriented Data Analyst with a strong background in <strong>math, statistics, and problem solving</strong>. Skilled in <strong>Python (Pandas, NumPy, Matplotlib, Seaborn)</strong> for data cleaning, visualization, and deriving actionable insights. Passionate about turning complex data into clear, impactful solutions to support data-driven decisions.
</p>
