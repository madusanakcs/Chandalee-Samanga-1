...
import "./about.css";
import AboutImg from "../../src/assets/chandalee_profile.png"; // Updated placeholder image file name
import CV from "../../src/assets/Chandalie_Kalubandara_CV .pdf"; // Updated placeholder CV file name
import Info from './Info'; // Assuming this component contains the experience/project count details
  ...
  return (
    <section className="about section" id="about">
        ...
        <div className="about__container container grid">
          {/* Using the updated image placeholder */}
          <img src={AboutImg} alt="Chandalee Kalubandara Profile" className="about__img" />
